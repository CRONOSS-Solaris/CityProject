...
(katalog z `build.gradle`), rozwiązywalność **wszystkich** linków wewnętrznych w mapach, to że hub
wymienia każdy wykryty subprojekt, oraz **kompletność** — każdy top-level pakiet/klasa pluginu
